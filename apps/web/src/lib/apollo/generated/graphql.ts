...
export type AddEventEntryMutation = {
  __typename?: "Mutation";
  addEventEntry: {
    __typename?: "EventEntry";
    id: string;
...
export type ToggleGameFollowMutation = {
  __typename?: "Mutation";
  toggleGameFollow: boolean;
};
...
export type ToggleEventFollowMutation = {
  __typename?: "Mutation";
  toggleEventFollow: boolean;
};
...
export type IsFollowingGameQuery = {
  __typename?: "Query";
  isFollowingGame: boolean;
};
...
export type IsFollowingEventQuery = {
  __typename?: "Query";
...
export type GameFollowCountQuery = {
  __typename?: "Query";
...
export type EventFollowCountQuery = {
  __typename?: "Query";
  eventFollowCount: number;
};
...
export type SetGameStaffMutation = {
  __typename?: "Mutation";
  setGameStaff: Array<{
    __typename?: "GameStaff";
    id: string;
...
export type GetGlobalGameManagersQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetGlobalGameManagersQuery = {
  __typename?: "Query";
  globalGameManagers: Array<{
    __typename?: "User";
    id: string;
    name: string;
    username: string;
...
export type CreateLeagueMutation = {
  ...
  createLeague: {
    ...
    event?: {
      ...
      thumbnailImagePath?: string | null;
      game: { __typename?: "Game"; id: string; slug: string };
    } | null;
  };
};
...
export type GetEventEntriesQuery = {
  __typename?: "Query";
  eventEntries: {
    __typename?: "PaginatedEventEntries";
    totalCount: number;
...
export const AddEventEntryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "AddEventEntry" },
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: "NamedType",
              name: { kind: "Name", value: "CreateEventEntryInput" },
            },
          },
        },
      ],
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: "Field", name: { kind: "Name", value: "entryStatus" } },
...
export const ToggleGameFollowDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ToggleGameFollow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  ToggleGameFollowMutation,
  ToggleGameFollowMutationVariables
>;
export const ToggleEventFollowDocument = {
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "ToggleEventFollow" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  ToggleEventFollowMutation,
  ToggleEventFollowMutationVariables
>;
export const IsFollowingGameDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "IsFollowingGame" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  IsFollowingGameQuery,
  IsFollowingGameQueryVariables
>;
export const IsFollowingEventDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "IsFollowingEvent" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  IsFollowingEventQuery,
  IsFollowingEventQueryVariables
>;
export const GameFollowCountDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GameFollowCount" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  GameFollowCountQuery,
  GameFollowCountQueryVariables
>;
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "mutation",
      name: { kind: "Name", value: "SetGameStaff" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "GameStaffMemberInput" },
                },
              },
            },
          },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "isFullAccess" },
                },
                {
                  kind: "Field",
  ...
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetGameStaff" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "gameStaff" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "gameId" },
...
} as unknown as DocumentNode<GetGameStaffQuery, GetGameStaffQueryVariables>;
export const GetGlobalGameManagersDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetGlobalGameManagers" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "globalGameManagers" },
            selectionSet: {
              kind: "SelectionSet",
              selections: [
                { kind: "Field", name: { kind: "Name", value: "id" } },
  ...
  GetGlobalGameManagersQueryVariables
>;
...
>;
export const DeleteLeagueDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            ...
                            {
                              kind: "Field",
                              name: { kind: "Name", value: "topEntries" },
                              selectionSet: {
                                kind: "SelectionSet",
                                selections: [
                                  {
...
export const GetEventEntriesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetEventEntries" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
              ...
              selections: [
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "entryStatus" },
                      },
