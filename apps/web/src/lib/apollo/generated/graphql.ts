...
export type GetUserQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name: string, username: string, imagePath?: string | null, bio?: string | null, profileColor?: string | null, isAdmin: boolean, createdAt: any } | null };
